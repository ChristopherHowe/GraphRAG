...
![Prompt and Response Example](assets/prompt_example.png)


## Project Architecture
It's is built with a modular, service-oriented architecture using Docker containers:

![HybridRAG Architecture Diagram](assets/architecture_diagram.png)
...
![Knowledge Graph Example](assets/graph_example.png)
